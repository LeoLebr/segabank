...
public class ComptePayantDAO implements IDAO<Integer, ComptePayant> {
    ...
    private static final String FIND_ID_QUERY = "SELECT * FROM compte WHERE id = ? AND type = 3";
    private static final String FIND_ALL_COMPTE_QUERY = "SELECT * FROM compte WHERE type = 3";
    ...
    public void create(ComptePayant comptePayant) throws SQLException, IOException, ClassNotFoundException {
        ...
        if (connection != null) {
            try (PreparedStatement ps = connection
                ...
                ps.setInt(3, comptePayant.getAgenceId());
                ps.executeUpdate();
            ...
            try (PreparedStatement ps = connection.prepareStatement(FIND_ID_QUERY)) {
                ...
                try (ResultSet rs = ps.executeQuery()) {
                    if (rs.next()) {
                        ...
                        comptePayant.setAgenceId(agence.getId());
                    }
                }
            }
        }
